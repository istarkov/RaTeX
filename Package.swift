...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RaTeXFFI",
            url: "https://github.com/erweixin/RaTeX/releases/download/v0.1.12/RaTeX.xcframework.zip",
            checksum: "a29607a3aab6f217b3ada33739a13c027f9aa12e14762c3dd68260fa34e59fa6"
        ),
