...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RaTeXFFI",
            url: "https://github.com/erweixin/RaTeX/releases/download/v0.1.7/RaTeX.xcframework.zip",
            checksum: "d22aa4924aeb79542a58ef68f0cbfc2dcbea2cef208bee3624265baa0917ee75"
        ),
